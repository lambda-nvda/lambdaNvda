...
The current version of the addon has braille tables for Italian and Spanish languages only but its interface is available in Italian, galician and Spanish, English and Galician right now.
